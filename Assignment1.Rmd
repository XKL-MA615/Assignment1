...
First, I know how to build a github repo as the assignment words.

Second, from these two R file, the car_viz.R shows how to use ggplot and try it by myself. And hand_functions.R is an example of building a function we need in the program.